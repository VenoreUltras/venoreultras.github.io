...
- [x] **Phase 5: Educational Layer** — Tooltips, free-roam, difficulty modes, audio, 3D labels, rationale, keyboard shortcuts (completed 2026-05-27)
...
- [x] 05-07-PLAN.md — Application wiring + bootstrap localStorage + modal-aware pause + dispose chain + boundaries +5 entries + integration test + manual QA
...
- [x] 06-02-PLAN.md — Store schema: session.attempts[] + retry() + attemptBimanualStep + machineStateAttest auto-trigger + angle injection
- [x] 06-03-PLAN.md — 3 scenariusze (cykl-pracy/zatrzymanie/awaria) + 3 integration tests (TEST-05)
- [x] 06-04-PLAN.md — ReplayEngine (deterministic re-execution) + ReplayDrawer + DOM/CSS (542/542 tests; EDU-04 done)
- [x] 06-05-PLAN.md — StepPanel retry button + RaycastController bimanual flow + bimanual hint
- [x] 06-06-PLAN.md — ScoringService.computeMetrics + sessionPersistence + JsonExporter
- [x] 06-07-PLAN.md — PdfExporter (jsPDF + Noto Sans TTF) + SessionOverlay + StatusPanel ScenarioSelector
- [ ] 06-08-PLAN.md — Application wiring + KeyboardController 1-4 + manual QA checkpoint
**UI hint**: yes
...
| 6. Scenarios + Replay + Retry + Export | 7/8 | In Progress|  |
